                    ...
                    <div class="report-body py-2">
                        <div class="row mb-3">
                            <div class="insert col-12 col-md-11">
                                <form action="{{ route('comment.update', $id = $comment->id) }}" id="submit">
                                    <div class="mb-3">
                                        <label for="content" class="form-label">Content</label>
                                        <input type="content" class="form-control color-input" id="content" name="content" value="{{ $comment->content }}" required>
