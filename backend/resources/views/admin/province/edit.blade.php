                    ...
                    <div class="report-body py-2">
                        <div class="row mb-3">
                            <div class="insert col-12 col-md-11">
                                <form action="{{ route('province.update', $id = $provinsi->id) }}" id="submit">
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Nama</label>
                                        <input type="name" class="form-control color-input" id="name" name="name" value="{{ $provinsi->name }}" required>
