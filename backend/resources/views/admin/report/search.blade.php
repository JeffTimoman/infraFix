                ...
                <div class="row mb-3 col-12 col-md-11 ">
                    <div class="search col-md-8">
                        <div class="form col-md-11">
                            <form action="{{ route('admin.report.index')}}" class="d-flex" role="search" method="GET">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions col-12 col-md-12">
                                            <div class="detail ">
                                                <a href="{{ route('admin.report.details', $id = $item->id) }}">
                                            ...
                                            <div class="delete">
                                                <a href="{{ route('admin.report.destroy', $id = $item->id) }}">
                                                    <span class="material-symbols-outlined">
                                                        delete
                                                    </span>
                                                </a>
