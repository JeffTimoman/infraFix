                    ...
                    <div class="report-body py-2">
                        <div class="row mb-3">
                            <div class="insert col-12 col-md-11">
                                <form action="{{ route('case.store') }}" id="submit">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="coordinate" class="form-control color-input" id="coordinate" name="coordinate" required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control color-input" id="government" name="government" required>
